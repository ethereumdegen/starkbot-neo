...
| **M13** Video | Video frames, timeline dock, compile-to-keyframes, preview seeking, clips, captions, audio, MP4/GIF/animated SVG, `canvas_*` timeline tools | "make a 10-second vertical launch video from the ad" → scenes + captions + music → MP4 1080×1920 30 fps, reproducible frames, A/V in sync (± 1 frame), render ≤ 2× real time |
